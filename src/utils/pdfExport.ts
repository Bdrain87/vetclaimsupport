...
const createPDFWrapper = (content: string, options: PDFExportOptions) => {
  ...
  return `
    ...
    <body>
      ...
      ${content}
      <div class="footer">
        <p style="font-weight: bold; margin-bottom: 10px;">⚠️ DISCLAIMER</p>
        <p>This document was generated by Service Evidence Tracker for personal record-keeping purposes only. 
        It is not an official VA document and should not be submitted as such. 
        Official records must be obtained from military and medical facilities.</p>
        <p style="margin-top: 10px;">Present this document to your VA representative, VSO, or use it to organize your claim materials.</p>
      </div>
    </body>
    </html>
  `;
