...
const addPDFFooter = (doc: jsPDF) => {
  ...
  doc.setFont('helvetica', 'normal');
  const disclaimer = 'This document was generated by Vet Claim Support for personal record-keeping purposes only. It is not an official VA document and should not be submitted as such.';
