...
<div className="flex-1 flex flex-col overflow-hidden">
        <MobileHeader />
        <main id="main-content" className="flex-1 overflow-y-auto" style={location.pathname === '/onboarding' ? {} : { paddingTop: 'calc(56px + env(safe-area-inset-top, 0px))', paddingBottom: 'calc(56px + env(safe-area-inset-bottom, 0px) + 16px)' }}>
          <AnimatedRoutes />
        </main>
        <BottomTabBar />
      </div>
