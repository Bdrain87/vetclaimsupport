  ...
  return (
    <div className="glass-card p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="text-white/40 hover:text-[#3B82F6] transition-colors"><History size={20} /></button>
      </div>
      ...
      <div className="relative">
        <textarea
          ...
          className="w-full h-48 bg-navy-950/50 border border-white/10 rounded-2xl p-6 text-white placeholder:text-white/30 outline-none focus:border-[#3B82F6]/50 transition-all resize-none font-medium leading-relaxed"
        ...
        <div className="absolute bottom-4 right-4 flex gap-2">
          <button
            ...
            disabled={isLoading}
            className="flex items-center gap-2 px-4 py-2 bg-[#3B82F6] text-[#102039] rounded-xl font-black text-[10px] uppercase tracking-tighter hover:scale-105 active:scale-95 transition-all shadow-lg disabled:opacity-50"
          >
