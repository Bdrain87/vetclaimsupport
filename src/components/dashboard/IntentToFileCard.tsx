...
export function IntentToFileCard() {
  ...
  return (
    <Card className={cn(
      ...
      "bg-gradient-to-r from-amber-500/10 via-amber-400/5 to-orange-500/10",
      ...
      <CardContent className="pt-4 pb-4 pl-6 pr-4">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute right-2 top-2 h-8 w-8 text-muted-foreground hover:text-foreground hover:bg-amber-500/10"
        ...
        <div className="flex items-start gap-4 pr-8">
          ...
          <div className="relative flex-shrink-0">
            <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-amber-400/20 to-orange-500/20 border border-amber-500/30 flex items-center justify-center">
              <Flag className="h-6 w-6 text-amber-500" />
            </div>
            {/* Subtle glow */}
            <div className="absolute inset-0 bg-amber-400/20 blur-xl rounded-full scale-150 -z-10" />
          </div>
          ...
          <div className="space-y-2 flex-1">
            ...
            <div className="space-y-1.5 text-sm text-muted-foreground">
              <p>
                ...
                your effective date for <strong className="text-amber-600 dark:text-amber-400">up to 1 year</strong> while
                you gather evidence.
              </p>
              <p className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-amber-500 flex-shrink-0" />
                <span>This could mean <strong className="text-amber-600 dark:text-amber-400">thousands in back pay</strong> if approved.</span>
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              ...
              >
                <Button
                  size="sm"
                  className="h-9 gap-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-500/90 hover:to-orange-500/90 text-white font-semibold shadow-md shadow-amber-500/20"
                >
                  File Intent to File
