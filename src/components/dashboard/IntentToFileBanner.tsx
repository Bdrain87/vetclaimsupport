        ...
        >
          <div className="rounded-xl border-2 border-gold/50 bg-card p-4 relative overflow-hidden">
            ...
            <div
              ...
              style={{ background: 'linear-gradient(90deg, #D4A800 0%, #F0C000 20%, #FFD700 50%, #F0C000 80%, #D4A800 100%)' }}
              aria-hidden="true"
            />
              ...
              <div className="flex-1 min-w-0 space-y-2">
                ...
                <div className="flex flex-wrap gap-2 pt-1" role="group" aria-label="Intent to File actions">
                  <Link
                    ...
                    style={{ background: 'linear-gradient(90deg, #D4A800 0%, #F0C000 20%, #FFD700 50%, #F0C000 80%, #D4A800 100%)', color: '#000' }}
                  >
                    Learn How to File
