        ...
        >
          <div className="rounded-xl border-2 border-gold/50 bg-card p-4 relative overflow-hidden">
            ...
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #CCA530 0%, #E8C03A 25%, #F8E48A 50%, #E8C03A 75%, #CCA530 100%)' }}
              aria-hidden="true"
            />
              ...
              <div className="flex-1 min-w-0 space-y-2">
                ...
                <div className="flex flex-wrap gap-2 pt-1" role="group" aria-label="Intent to File actions">
                  <Link
                    ...
                    style={{ background: 'linear-gradient(135deg, #CCA530 0%, #E8C03A 25%, #F8E48A 50%, #E8C03A 75%, #CCA530 100%)', color: '#000' }}
                  >
                    Learn How to File
