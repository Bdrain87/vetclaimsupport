      ...
      if (!achieved.includes(milestone.id) && milestone.condition(data)) {
        ...
        setTimeout(() => {
          confetti({
            ...
            spread: 70,
            origin: { y: 0.6 },
            colors: ['#3B82F6', '#60A5FA', '#2563EB', '#60A5FA'],
          });
        }, 200);
  ...
  return (
    <Dialog open={showCelebration} onOpenChange={setShowCelebration}>
      <DialogContent className="sm:max-w-md" aria-describedby="milestone-description">
        <DialogHeader>
          <DialogTitle className="text-center flex items-center justify-center gap-2"><Trophy className="h-5 w-5 text-[#3B82F6]" /> Milestone Achieved!</DialogTitle>
