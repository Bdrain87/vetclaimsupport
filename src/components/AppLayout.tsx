...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex w-full bg-background overflow-x-hidden max-w-[100vw]">
      ...
      {/* Main Content - margin adjusts for sidebar collapsed (w-16) vs expanded (w-64) */}
      <div className={`flex-1 transition-all duration-300 flex flex-col h-screen md:min-h-screen overflow-hidden max-w-[100vw] ${collapsed ? 'md:ml-16' : 'md:ml-64'}`}>
