          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0 flex-1">
                <CardTitle className="text-lg break-words">{selectedCondition} C&P Exam Prep</CardTitle>
                <CardDescription>
                  Condition-specific guidance for your {selectedPrep.category} exam
                </CardDescription>
              </div>
              <Badge variant="secondary" className="shrink-0">{selectedPrep.category}</Badge>
            </div>
          </CardHeader>
          <CardContent>
