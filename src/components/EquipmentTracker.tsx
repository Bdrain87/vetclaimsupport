...
export const EquipmentTracker = () => {
  ...
  return (
    <div className="p-8 glass-card">
      ...
      <div className="space-y-4">
        {equipment.map((item, i) => (
          <motion.div
            ...
            className="p-4 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-between group hover:border-[#3B82F6]/30 transition-colors"
          >
            <div className="flex items-center gap-4">
              <div className="h-10 w-10 rounded-xl bg-[#3B82F6]/10 flex items-center justify-center text-[#3B82F6]">
            ...
            <div className="text-right">
              <p className="text-[#3B82F6] text-[10px] font-black uppercase tracking-widest">{item.connection} Nexus</p>
      ...
      <div className="mt-8 p-4 rounded-xl bg-[#3B82F6]/5 border border-[#3B82F6]/20 flex gap-3 items-start">
        <AlertCircle className="text-[#3B82F6] shrink-0" size={16} />
