  ...
  return (
    <div className="p-10 glass-card relative overflow-hidden group">
      <div className="flex justify-between items-start mb-6">
        <h3 className="text-gold text-[10px] font-black uppercase tracking-[0.3em]">Estimated Rating</h3>
        {detectedPairs.length > 0 && (
          <div className="flex items-center gap-2 px-3 py-1 bg-[var(--gold-border)] border border-[var(--gold-border-strong)] rounded-full animate-pulse">
            <Zap size={10} className="text-gold" />
            <span className="text-gold text-[9px] font-black uppercase">Bilateral Factor Active</span>
          </div>
        )}
      </div>

      <div className="text-9xl font-black italic text-white leading-none tracking-tighter" style={{ textShadow: '0 0 40px var(--gold-glow)' }}>
        {finalRating}%
      </div>
