...
function SectionHeader({ gold, sub }: { gold: string; sub?: string }) {
  return (
    ...
    >
      <h2
        className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-wide leading-tight"
...
function AppStoreBadge() {
  return (
    <Link
      to="/dashboard"
      className="inline-flex items-center gap-2.5 bg-black border border-white/20 rounded-xl px-5 py-2.5 hover:bg-white/10 transition-colors min-h-[48px]"
    >
  ...
  return (
    ...
    >
      <svg viewBox="0 0 512 512" width="22" height="24" fill="none" aria-hidden="true">
        <path
          d="M48 59.5v393a28.1 28.1 0 0 0 16.4 25.6l225.7-225.5L64.4 27.1A28.6 28.6 0 0 0 48 59.5z"
          fill="#4285F4"
        />
        <path
          d="M290.1 252.6l62.8-62.8L99.6 57.4a28 28 0 0 0-35.2-30.3l225.7 225.5z"
          fill="#34A853"
        />
        <path
          d="M290.1 252.6L64.4 478.1a28 28 0 0 0 35.2-30.3l253.3-132.4-62.8-62.8z"
          fill="#FBBC04"
        />
        <path
          d="M464 252.6c0-10.7-5.9-20.5-15.4-25.6l-95.8-50-62.8 62.8 62.8 62.8 95.8-50c9.5-5.1 15.4-14.9 15.4-25.6v-.4z"
          fill="#EA4335"
        />
      </svg>
      <div className="text-left">
  ...
  return (
    <div className="min-h-[100dvh] bg-[#102039] selection:bg-[#C8A628]/30 overflow-x-hidden max-w-full">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 sm:px-6 overflow-hidden pt-24 pb-12 sm:pt-32 sm:pb-16 sm:min-h-[100dvh]">
        {/* radial bg glow */}
        <motion.div style={{ scale: heroScale }} className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        >
          Whether you're still in uniform, just got your DD-214, or haven't touched your claim in 30 years — this is the tool that puts YOU in control of your claim.
        </motion.p>
        ...
        >
          <div className="relative bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-xl shadow-black/30">
            ...
            <div className="flex items-baseline justify-center gap-3 mb-1">
              ...
              <span className="text-5xl sm:text-6xl font-black" style={goldGradientStyle}>
                $4.99
              </span>
            </div>
        ...
        >
          ...
          <GlassCard>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              You have 180 days before separation to file a BDD claim — and walk out with a rating and a check waiting. Most service members don't know this exists. The ones who do? They build their case before they take off the uniform.
            </p>
          ...
          <GlassCard>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              The clock is ticking on your presumptive window. Every condition you don't document now gets harder to prove later. Stop Googling symptoms at 2 AM. Start building your case with the tools the pros use.
            </p>
          ...
          <GlassCard>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              New presumptive conditions get added every year. The PACT Act alone opened the door for millions. It doesn't matter if you served in Vietnam, Desert Storm, Iraq, or Afghanistan — if it's service-connected, it's owed. It's never too late.
            </p>
            <Link to="/conditions" className="inline-flex items-center text-[#C8A628] font-bold text-base min-h-[44px] group">
              See What You May Qualify For <span className="ml-1 transition-transform duration-200 group-hover:translate-x-1">→</span>
            </Link>
          </GlassCard>
        </motion.div>
      </section>
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6 bg-black/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p>
              Claim sharks can charge $4,000 to $6,000 — or take 5x your monthly back pay — for work you can do yourself. Cookie-cutter nexus letters get denied. "Consultants" with no medical or legal credentials tell you what to file. And the VA? They count on you walking into your C&amp;P exam with nothing.
            </p>
          ...
          >
            {/* Competitor: Claim Shark — RED GLOW */}
            <motion.div
              variants={cardVariant}
              animate={{
                boxShadow: [
            ...
            {/* Competitor: VA Attorney — RED GLOW */}
            <motion.div
              variants={cardVariant}
              animate={{
                boxShadow: [
            ...
            {/* WINNER: Vet Claim Support — GOLD GLOW */}
            <motion.div
              variants={cardVariant}
              animate={{
                boxShadow: [
            ...
            >
              ...
              <p className="font-bold text-xl mb-3" style={goldGradientStyle}>
                $4.99 Launch Price
              </p>
              <GreenCheck size={8} />
            </motion.div>
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6 bg-black/40">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            No accounts. No cloud. No servers. No sign-ups. Your medical history, your symptoms, your conditions, your entire case — all of it stays on your device and nowhere else. We built it that way on purpose. Your evidence is yours. Period.
          </motion.p>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={cardVariant} className="flex flex-col items-center gap-3 text-center">
                <div className="w-16 h-16 flex items-center justify-center bg-white/5 rounded-2xl text-[#C8A628] border border-white/[0.08]">
                  {item.icon}
                </div>
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
            ...
            <p className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-none mb-4" style={goldGradientStyle}>
              $4.99
            </p>
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={cardVariant}
                className={`flex items-center justify-between px-5 sm:px-6 py-3 sm:py-4 rounded-xl border-2 ${
                  item.bad
                    ? 'bg-white/[0.02] border-red-500/60'
                    : 'bg-[#C8A628]/10 border-[#C8A628]/30'
                }`}
                style={item.bad ? { boxShadow: '0 0 12px rgba(239, 68, 68, 0.15), 0 0 24px rgba(239, 68, 68, 0.08)' } : undefined}
              >
                <span className={`text-sm sm:text-base ${item.bad ? 'text-white/70' : 'text-white font-semibold'}`}>
                  {item.text}
                </span>
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
            <h2
              className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-wide leading-tight mb-8 md:mb-10"
              style={goldGradientStyle}
            >
            ...
            <div className="border-l-4 border-[#C8A628]/60 pl-6 sm:pl-8">
              <p className="text-white/70 text-base sm:text-lg leading-relaxed max-w-[700px] mb-6 sm:mb-8">
                I'm a 100% service-connected disabled veteran. I went through the claims process myself — the confusion, the denials, the C&amp;P exams, the sharks who wanted thousands of dollars to do what I could do with the right tools. I built{' '}
                <em className="text-white italic">Vet Claim Support</em>{' '} because no service member or veteran should have to pay a predator to organize what's already theirs. This isn't a corporation. It's a weapon — built by a veteran, for service members and veterans.
              </p>
      ...
      <footer className="py-8 sm:py-12 px-4 sm:px-6 border-t border-white/5 bg-black/30">
        <div className="max-w-4xl mx-auto">
          <div className="space-y-3 sm:space-y-4 text-white/40 text-xs leading-relaxed mb-8 sm:mb-10">
            <p>
              Vet Claim Support is not affiliated with, endorsed by, or sponsored by the U.S. Department of Veterans Affairs or any government agency.
            </p>
            <p>
              This application does not provide legal, medical, or financial advice. All content is for informational and organizational purposes only.
            </p>
            <p>
              AI-assisted features provide suggestions based on publicly available regulations (38 CFR Part 4). Always verify with qualified professionals.
            </p>
            <p>
              Rating estimates are approximations based on published VA criteria and are not guarantees of actual VA disability ratings.
            </p>
            <p>
              All user data is stored locally on the user's device. Vet Claim Support does not collect, transmit, or store any personal or medical information.
            </p>
            <p>
              Statistics referenced (e.g., secondary condition counts, approval rates) are derived from publicly available VA data and medical literature.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 sm:pt-8 border-t border-white/5">
            <div className="flex items-center gap-6 text-white/40 text-xs">
              ...
              <Link to="/help" className="hover:text-white transition-colors min-h-[44px] inline-flex items-center">
                Contact
              </Link>
            </div>
