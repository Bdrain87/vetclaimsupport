...
const accentGradientStyle: React.CSSProperties = {
  background: 'linear-gradient(135deg, #C5A442 0%, #F5D680 50%, #C5A442 100%)',
...
function SectionHeader({ title, sub }: { title: string; sub?: string }) {
  return (
    <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="text-center mb-8 md:mb-12 px-4">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-wide leading-tight" style={accentGradientStyle}>
        {title}
      </h2>
      {sub && (
...
function GlassCard({ children, className = '' }: { children: React.ReactNode; className?: string }) {
  return (
    <motion.div
      ...
      className={`bg-white/[0.07] backdrop-blur-xl border border-white/[0.12] rounded-2xl p-6 sm:p-8 shadow-lg shadow-black/20 transition-all duration-300 ease-out hover:shadow-xl hover:shadow-[#C5A442]/10 hover:border-[#C5A442]/30 hover:-translate-y-1 ${className}`}
    >
      {children}
    </motion.div>
  );
...
function ToolCard({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) {
  return (
    <GlassCard>
      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#C5A442]/20 to-[#C5A442]/5 border border-[#C5A442]/30 flex items-center justify-center shadow-lg shadow-[#C5A442]/10 mb-5 transition-all duration-300 group-hover:shadow-[#C5A442]/20 group-hover:border-[#C5A442]/50 group-hover:scale-105">
        <span className="text-[#C5A442]">{icon}</span>
      </div>
...
function AccentIconCircle({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-[#C5A442]/40 bg-[#C5A442]/10 text-[#C5A442] mb-5">
      {children}
    </div>
  );
}
...
export const PlatinumLanding = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#000000] selection:bg-[#C5A442]/30 overflow-x-hidden max-w-full">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 sm:px-6 overflow-hidden pt-24 pb-12 sm:pt-32 sm:pb-16 sm:min-h-[100dvh]">
        ...
        <motion.div
          ...
          aria-hidden
        >
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(197,164,66,0.06)_0%,transparent_70%)]" />
        </motion.div>
        ...
        >
          YOUR CLAIM.{' '}
          <span className="text-[#C5A442]">YOUR EVIDENCE.</span>{' '}
          YOUR MONEY.
        </motion.h1>
        ...
        >
          <div className="relative bg-white/[0.07] backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-xl shadow-black/30">
            ...
            <div className="flex items-baseline justify-center gap-3 mb-1">
              ...
              <span className="text-5xl sm:text-6xl font-black" style={accentGradientStyle}>$4.99</span>
            </div>
            <p className="text-white/60 text-sm mb-6 text-center">Limited Time Launch Price</p>

            <Link
              to="/"
              className="block w-full bg-[#C5A442] hover:bg-[#A38A35] text-[#000000] font-bold text-lg py-3.5 rounded-xl transition-all duration-300 text-center hover:shadow-[0_0_30px_rgba(197,164,66,0.4)] active:scale-[0.98] min-h-[48px]"
            >
              Get Started Now →
            </Link>
          </div>
        ...
        >
          {[
            ...
            <motion.div key={i} variants={cardVariant} className="flex items-center gap-3 text-center md:text-left">
              <span className="text-[#C5A442] flex-shrink-0">{item.icon}</span>
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <GlassCard>
            <AccentIconCircle><Shield size={24} /></AccentIconCircle>
            ...
            <Link to="/prep" className="inline-flex items-center text-[#C5A442] font-bold text-base min-h-[44px] group">
          ...
          {/* Card 2 — Just Got Out */}
          <GlassCard>
            <AccentIconCircle><FileText size={24} /></AccentIconCircle>
            ...
            <Link to="/" className="inline-flex items-center text-[#C5A442] font-bold text-base min-h-[44px] group">
          ...
          <GlassCard>
            <AccentIconCircle><Flag size={24} /></AccentIconCircle>
            ...
            <Link to="/claims" className="inline-flex items-center text-[#C5A442] font-bold text-base min-h-[44px] group">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.div
              ...
              animate={{
                boxShadow: [
                  '0 0 20px rgba(197,164,66,0.2), 0 0 40px rgba(197,164,66,0.1)',
                  '0 0 30px rgba(197,164,66,0.4), 0 0 60px rgba(197,164,66,0.2)',
                  '0 0 20px rgba(197,164,66,0.2), 0 0 40px rgba(197,164,66,0.1)',
                ],
              }}
              transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
              className="relative rounded-2xl p-6 border-2 border-[#C5A442] text-center bg-gradient-to-b from-[#C5A442]/10 to-transparent scale-[1.03]"
            >
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#C5A442] text-[#000000] text-xs font-bold px-4 py-1 rounded-full shadow-lg whitespace-nowrap">
                BEST VALUE
              </div>
              <p className="text-white/70 text-sm mb-2 mt-1">Vet Claim Support</p>
              <p className="font-bold text-xl mb-3" style={accentGradientStyle}>$4.99 Launch Price</p>
              <GreenCheck size={8} />
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6 max-w-7xl mx-auto">
        <SectionHeader title="The Arsenal" sub="Every tool you need to understand, build, and support your claim." />
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6 bg-gradient-to-b from-[#0A1628]/40 via-[#0A1628]/20 to-transparent">
        <div className="max-w-7xl mx-auto">
          <SectionHeader
            title="Your Daily Evidence Machine"
          ...
          >
            {[
              ...
              <motion.div key={i} variants={cardVariant} className="flex flex-col items-center gap-3 text-center">
                <div className="w-16 h-16 flex items-center justify-center bg-white/5 rounded-2xl text-[#C5A442] border border-white/[0.12]">{item.icon}</div>
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#C5A442]/[0.04] blur-3xl" />
        </div>
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
            ...
            <p className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-none mb-4" style={accentGradientStyle}>$4.99</p>
      ...
      <section className="py-10 sm:py-12 md:py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-wide leading-tight mb-8 md:mb-10" style={accentGradientStyle}>
              Built by a Veteran Who Went Through It
            </h2>

            <div className="border-l-4 border-[#C5A442]/60 pl-6 sm:pl-8">
