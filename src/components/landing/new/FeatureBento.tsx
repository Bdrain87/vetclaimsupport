...
const CARDS: CardData[] = [
  ...
  {
    icon: Database,
    title: '790+ Condition Database',
    short: 'Browse every VA-rated disability condition',
    detail: 'Comprehensive database of over 790 VA disability conditions with rating criteria, common symptoms, and evidence tips.',
    capabilities: ['790+ conditions', 'Rating criteria', 'Symptom matching', 'Evidence guidance'],
    plan: 'Free Forever',
    category: 'Reference',
  },
  {
  ...
  // ── Premium: Document Builders ──────────────────
  {
    ...
    short: 'Build a structured personal statement for your claim',
    detail: 'Guided builder that helps you write a clear, organized personal statement documenting how your service connects to your conditions.',
  ...
  },
  {
    ...
    detail: 'Review the key criteria your examiner will evaluate on the DBQ so you can document and describe your symptoms accurately.',
    capabilities: ['DBQ criteria review', 'Rating level breakdowns', 'Symptom documentation', 'Condition-specific prep'],
    plan: 'Premium (from $14.99/mo)',
    category: 'Strategy',
  },
  {
    icon: ClipboardList,
    title: '70 Interactive DBQ Forms',
    short: 'Every VA DBQ with rating criteria and prep tips',
    detail: 'All 70 public VA Disability Benefits Questionnaires with key exam questions, rating criteria breakdowns, common mistakes, and condition-specific preparation guidance.',
    capabilities: ['All 70 VA DBQ forms', 'Rating criteria mapping', 'Key exam questions', 'Condition-specific prep tips', 'Common mistake warnings'],
    plan: 'Premium (from $14.99/mo)',
    category: 'Strategy',
  },
  {
  ...
  },
  {
    ...
    short: 'Estimate potential retroactive VA compensation',
    detail: 'Calculate estimated back pay based on rating, effective date, and dependents. Estimates only — actual VA determinations may differ.',
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 0 60px rgba(184,155,62,0.3)',
        }}
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: 'rgba(184,155,62,0.15)', border: '1px solid rgba(184,155,62,0.3)' }}
        >
        ...
        <div
          ...
          style={{
            backgroundColor: 'rgba(184,155,62,0.15)',
            color: GOLD,
          }}
        >
          {card.plan}
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  background: CARD_BG,
                  border: isInteractive ? '1px solid rgba(184,155,62,0.25)' : CARD_BORDER,
                  boxShadow: isInteractive ? `${CARD_SHADOW}, 0 0 15px rgba(184,155,62,0.08)` : CARD_SHADOW,
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div
                    ...
                    style={{
                      backgroundColor: 'rgba(184,155,62,0.12)',
                      border: '1px solid rgba(184,155,62,0.25)',
                    }}
                  >
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: card.plan.startsWith('Free')
                        ? 'rgba(34,197,94,0.12)'
                        : 'rgba(184,155,62,0.12)',
                      ...(card.plan.startsWith('Free')
                        ? { color: '#22C55E' }
                        : {
                            backgroundImage: 'linear-gradient(90deg, #9E8A3C 0%, #B89B3E 25%, #CEAF4A 50%, #B89B3E 75%, #9E8A3C 100%)',
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div
              ...
              style={{ backgroundColor: 'rgba(184,155,62,0.15)' }}
            >
