...
export function SocialProof() {
  return (
    <section className="py-4 md:py-6" style={{ backgroundColor: LANDING_BG_CARD, borderTop: '1px solid rgba(184,155,62,0.15)', borderBottom: '1px solid rgba(184,155,62,0.15)' }}>
      <motion.div
