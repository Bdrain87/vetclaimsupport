            ...
            {stat.isText ? (
              <div className="flex items-center justify-center h-[36px] md:h-[40px]">
                <svg width="52" height="36" viewBox="-2 -2 64 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Stars — lighter gold */}
                  <circle cx="5" cy="4" r="1.2" fill="#D4AF37"/>
                  <circle cx="12" cy="4" r="1.2" fill="#D4AF37"/>
                  <circle cx="19" cy="4" r="1.2" fill="#D4AF37"/>
                  <circle cx="8.5" cy="7.5" r="1.2" fill="#D4AF37"/>
                  <circle cx="15.5" cy="7.5" r="1.2" fill="#D4AF37"/>
                  <circle cx="5" cy="11" r="1.2" fill="#D4AF37"/>
                  <circle cx="12" cy="11" r="1.2" fill="#D4AF37"/>
                  <circle cx="19" cy="11" r="1.2" fill="#D4AF37"/>
                  <circle cx="8.5" cy="14.5" r="1.2" fill="#D4AF37"/>
                  <circle cx="15.5" cy="14.5" r="1.2" fill="#D4AF37"/>
                  <circle cx="5" cy="18" r="1.2" fill="#D4AF37"/>
                  <circle cx="12" cy="18" r="1.2" fill="#D4AF37"/>
                  <circle cx="19" cy="18" r="1.2" fill="#D4AF37"/>
                </svg>
              </div>
            ) : (
