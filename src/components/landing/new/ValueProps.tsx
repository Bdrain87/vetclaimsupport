...
function ClipboardIcon() {
  return (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#9E8A3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {PROPS.map(({ Icon, title, desc }) => (
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-[#CEAF4A] transition-colors duration-300">{title}</h3>
              ...
              <div
                ...
                style={{
                  background: 'radial-gradient(ellipse at 50% 100%, rgba(184, 155, 62, 0.06) 0%, transparent 60%)',
                }}
              />
            </motion.div>
          ))}
