    ...
    >
      <motion.div
        ...
        style={{
          scale: bgScale,
          background: `
            radial-gradient(ellipse at 50% 50%, rgba(184,155,62,0.1) 0%, transparent 50%),
            radial-gradient(ellipse at 20% 80%, rgba(184,155,62,0.04) 0%, transparent 40%),
            radial-gradient(ellipse at 80% 20%, rgba(184,155,62,0.04) 0%, transparent 40%)
          `,
        }}
      />
      ...
      <motion.div
        ...
        style={{
          opacity: glowOpacity,
          background: 'radial-gradient(circle, rgba(184,155,62,0.06) 0%, transparent 70%)',
          filter: 'blur(40px)',
        }}
      />
