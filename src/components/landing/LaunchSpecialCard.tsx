...
export function LaunchSpecialCard() {
  ...
  return (
    <div className="p-12 rounded-[3rem] bg-navy-800 border-2 border-blue-500 shadow-2xl overflow-hidden relative">
      {isLaunchWindow && (
      ...
      <p className="text-blue-500 font-bold tracking-tighter uppercase mt-2">
      ...
      <button className="w-full mt-8 py-5 bg-blue-500 text-navy-900 font-black rounded-2xl hover:scale-[1.02] active:scale-95 transition-all">
        UNLOCK PRO SUITE
      </button>
    </div>
  );
