...
export function MedicationCombobox({
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'Pain': return 'bg-[#D4AF37]/10 text-[#D4AF37] border-[#D4AF37]/20';
      ...
      case 'GI': return 'bg-[#D4AF37]/10 text-[#B38728] border-[#D4AF37]/20';
      case 'Blood Pressure': return 'bg-red-500/10 text-red-500 border-red-500/20';
      case 'Diabetes': return 'bg-[#D4AF37]/10 text-[#D4AF37] border-[#D4AF37]/20';
      ...
      case 'Topical': return 'bg-[#D4AF37]/10 text-[#B38728] border-[#D4AF37]/20';
