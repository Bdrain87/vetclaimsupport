...
export function MedicationCombobox({
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'Pain': return 'bg-amber-500/10 text-amber-500 border-amber-500/20';
      ...
      case 'GI': return 'bg-orange-500/10 text-orange-500 border-orange-500/20';
      case 'Blood Pressure': return 'bg-red-500/10 text-red-500 border-red-500/20';
      case 'Diabetes': return 'bg-amber-500/10 text-amber-500 border-amber-500/20';
      ...
      case 'Topical': return 'bg-amber-500/10 text-amber-500 border-amber-500/20';
