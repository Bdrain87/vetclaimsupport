...
export function MOSCombobox({
  ...
  const getBranchColor = (branch: string) => {
    switch (branch) {
      ...
      case 'Air Force': return 'bg-gold/20 text-[#7B5E1A] dark:text-gold-hl border-gold/30';
      ...
      case 'Coast Guard': return 'bg-gold/20 text-[#7B5E1A] dark:text-gold-hl border-gold/30';
