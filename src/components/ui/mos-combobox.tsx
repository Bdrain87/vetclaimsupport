...
export function MOSCombobox({
  ...
  const getBranchColor = (branch: string) => {
    switch (branch) {
      ...
      case 'Air Force': return 'bg-[#D4AF37]/20 text-[#7B5E1A] dark:text-[#F0D78C] border-[#D4AF37]/30';
      ...
      case 'Coast Guard': return 'bg-[#D4AF37]/20 text-[#7B5E1A] dark:text-[#F0D78C] border-[#D4AF37]/30';
