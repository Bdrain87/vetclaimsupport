...
const JS_SIZE_BUDGET_KB = 2800; // per-chunk budget (raised for App chunk with 90+ pages)
const CSS_SIZE_BUDGET_KB = 300;
const TOTAL_JS_BUDGET_KB = 7000; // total JS budget (raised for Phase 5 features + condition data)
