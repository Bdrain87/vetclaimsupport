...
export const hoverGlow = (color: string = 'rgba(184,155,62,0.3)') => ({
  y: -4,
...
// --- LUXURY GOLD PALETTE ---
// Dark: #9E8A3C | Primary: #B89B3E | Light: #CEAF4A
// Richer, warmer jewelry gold - not champagne, not mustard
export const GOLD = '#B89B3E';
export const GOLD_DARK = '#9E8A3C';
export const GOLD_LIGHT = '#CEAF4A';
export const GOLD_GRADIENT = 'linear-gradient(90deg, #9E8A3C 0%, #B89B3E 25%, #CEAF4A 50%, #B89B3E 75%, #9E8A3C 100%)';
...
export const SECTION_TOP_GLOW_GOLD = 'linear-gradient(180deg, rgba(184,155,62,0.04) 0%, transparent 30%)';

// --- PILL LABEL STYLE ---
export const PILL_STYLE = {
  background: 'linear-gradient(90deg, #9E8A3C 0%, #B89B3E 25%, #CEAF4A 50%, #B89B3E 75%, #9E8A3C 100%)',
  WebkitBackgroundClip: 'text',
  WebkitTextFillColor: 'transparent',
...
@keyframes pulse-glow {
  0%, 100% { box-shadow: 0 0 20px rgba(184,155,62,0.1); }
  50% { box-shadow: 0 0 40px rgba(184,155,62,0.25); }
}
...
export const MESH_GRADIENT_1 = 'radial-gradient(ellipse 80% 50% at 30% 50%, rgba(184,155,62,0.06) 0%, transparent 70%)';
export const MESH_GRADIENT_2 = 'radial-gradient(ellipse 60% 60% at 70% 40%, rgba(100,130,180,0.04) 0%, transparent 70%)';
export const MESH_GRADIENT_3 = 'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(184,155,62,0.05) 0%, transparent 60%)';
