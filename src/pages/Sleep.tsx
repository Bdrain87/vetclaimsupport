...
export default function Sleep() {
  ...
  const estimatedRating = useMemo(() => {
    ...
    if (hasSevereSleepiness) return { rating: '30%', color: 'text-[#D4AF37]', note: 'Persistent daytime hypersomnolence' };
  ...
  const getQualityColor = (quality: SleepQuality) => {
    switch (quality) {
      ...
      case 'Poor': return 'bg-[#D4AF37]/10 text-[#D4AF37] border-[#D4AF37]/20';
  ...
  return (
    <PageContainer className="space-y-6 animate-fade-in overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="p-3 rounded-2xl bg-gradient-to-br from-[#D4AF37]/20 to-[#D4AF37]/5 shadow-[0_0_24px_rgba(212,175,55,0.2)]">
            <Moon className="h-6 w-6 text-[#D4AF37] drop-shadow-[0_0_8px_rgba(212,175,55,0.5)]" />
          </div>
          <div>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/5 border border-[#D4AF37]/30 p-5 shadow-lg" style={{ boxShadow: '0 4px 24px rgba(212, 175, 55, 0.15)' }}>
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          ...
          <div className="bg-background/60 rounded-xl p-3 border border-[#D4AF37]/30">
            <span className="font-bold text-[#F0D78C] text-lg">30%</span>
      ...
      <Dialog open={isOpen} onOpenChange={(open) => { setIsOpen(open); if (!open) resetForm(); }}>
        <DialogTrigger asChild>
          <Button className="gap-2 bg-[#D4AF37] hover:bg-[#B38728] text-[#000000] shadow-[0_4px_16px_rgba(212,175,55,0.3)]">
              ...
              <ScrollArea className="flex-1 pr-4">
                <div className="space-y-4 pb-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {formData.usesCPAP && (
                      <div className="ml-4 space-y-3 border-l-2 border-[#D4AF37]/30 pl-4">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="data-card">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              <Wind className="h-8 w-8 text-[#D4AF37]" />
              <div>
      ...
      {(stats.nightmaresLast30Days > 0 || stats.severeSleepiness > 0 || stats.oxygenDrops > 0) && (
        <div className="grid gap-4 grid-cols-3 sm:grid-cols-3">
          ...
          <Card className="data-card">
            <CardContent className="pt-4 pb-4">
              <div className="text-center">
                <p className="text-xl font-bold text-[#D4AF37]">{stats.severeSleepiness}</p>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {entry.timesWokeGasping && entry.timesWokeGasping > 0 && (
                        <Badge variant="outline" className="text-xs text-[#D4AF37] border-[#D4AF37]/50">Gasping x{entry.timesWokeGasping}</Badge>
                      )}
