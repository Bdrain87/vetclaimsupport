...
export default function Sleep() {
  ...
  return (
    <PageContainer className="space-y-6 animate-fade-in overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="p-3 rounded-2xl bg-gradient-to-br from-gold/20 to-gold/5 shadow-[0_0_24px_var(--gold-glow)]">
            <Moon className="h-6 w-6 text-gold drop-shadow-[0_0_8px_rgba(212,175,55,0.5)]" />
          </div>
          <div>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-gold/10 to-gold/5 border border-gold/30 p-5 shadow-lg" style={{ boxShadow: '0 4px 24px rgba(212, 175, 55, 0.15)' }}>
      ...
      <Dialog open={isOpen} onOpenChange={(open) => { setIsOpen(open); if (!open) resetForm(); }}>
        <DialogTrigger asChild>
          <Button className="gap-2 bg-gold hover:bg-[#B38728] text-[#000000] shadow-[0_4px_16px_rgba(212,175,55,0.3)]">
              ...
              <ScrollArea className="flex-1 pr-4">
                <div className="space-y-4 pb-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {formData.usesCPAP && (
                      <div className="ml-4 space-y-3 border-l-2 border-gold/30 pl-4">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="data-card">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              <Wind className="h-8 w-8 text-gold" />
              <div>
      ...
      {(stats.nightmaresLast30Days > 0 || stats.severeSleepiness > 0 || stats.oxygenDrops > 0) && (
        <div className="grid gap-4 grid-cols-3 sm:grid-cols-3">
          ...
          <Card className="data-card">
            <CardContent className="pt-4 pb-4">
              <div className="text-center">
                <p className="text-xl font-bold text-gold">{stats.severeSleepiness}</p>
