...
const faqData: FAQItem[] = [
  ...
  { id: 'faq-8', category: 'claims', question: 'What is a nexus letter?', answer: 'A nexus letter is a medical opinion from a doctor stating that your current condition is "at least as likely as not" connected to your military service. It\'s crucial evidence for service connection.' },
  ...
  { id: 'faq-11', category: 'evidence', question: 'What evidence do I need for my claim?', answer: 'Key evidence includes: Service Treatment Records (STRs), current medical records showing diagnosis, nexus letters linking conditions to service, buddy statements from witnesses, and consistent symptom documentation.' },
                          ...
                          {section.steps.map((step, i) => (
                            <div key={i} className="flex gap-4">
                              ...
                              <div className="flex-1">
                                ...
                                {step.tip && (
                                  <div className="flex items-start gap-2 mt-2 p-2 rounded-lg bg-amber-500/10 text-amber-700 dark:text-amber-500">
