  ...
  return (
    <PageContainer className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Badge variant="outline" className="bg-[#C5A442]/10 border-[#C5A442]/30">
      ...
      <Card className="bg-primary/5 border-primary/20">
        <CardContent className="py-4">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground inline-flex items-center gap-1"><Lightbulb className="h-4 w-4 text-[#C5A442]" /> Tip:</strong> This timeline helps demonstrate service connection 
