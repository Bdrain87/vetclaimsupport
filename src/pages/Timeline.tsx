  ...
  return (
    <PageContainer className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Badge variant="outline" className="bg-[#D4AF37]/10 border-[#D4AF37]/30">
      ...
      <Card className="bg-primary/5 border-primary/20">
        <CardContent className="py-4">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground inline-flex items-center gap-1"><Lightbulb className="h-4 w-4 text-[#D4AF37]" /> Tip:</strong> This timeline helps demonstrate service connection 
