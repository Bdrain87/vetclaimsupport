  ...
  return (
    <PageContainer className="space-y-6 animate-fade-in py-8">
      ...
      <div className="flex items-start gap-4">
        <div className="p-3 rounded-xl bg-[#D6B25E]/10 shrink-0">
      ...
      <div className="space-y-8 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-1.5 text-muted-foreground">
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>Educational resources about VA benefits and processes</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>Health and symptom logging tools</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>Evidence organization and tracking</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>VA form drafting assistance</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>AI-powered writing suggestions</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>Rating calculators and estimators</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>C&amp;P exam preparation materials</li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-1.5 text-muted-foreground">
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>(a) The accuracy and truthfulness of all information you enter into the Service</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>(b) Reviewing, editing, and verifying ALL content &mdash; including AI-generated content &mdash; before using it in any VA submission</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>(c) Ensuring any documents you submit to the VA are truthful, accurate, and complete</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>(d) Consulting with accredited professionals when appropriate</li>
            <li className="flex items-start gap-2"><span className="text-[#D6B25E] mt-0.5">&#x2022;</span>(e) Verifying current VA form versions, requirements, and deadlines</li>
          </ul>
          <div className="rounded-xl bg-red-500/5 border border-red-500/20 p-4">
            <p className="text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <div className="rounded-xl bg-[rgba(214,178,94,0.05)] border border-[rgba(214,178,94,0.2)] p-4">
            <p className="text-muted-foreground">
              Any case law citations, BVA decisions, Federal Circuit rulings, or legal authorities generated by this Service are produced by artificial intelligence and <strong className="text-gold">ARE NOT VERIFIED</strong>. AI systems are known to fabricate case names, citation numbers, holdings, and legal reasoning that do not exist in any court database.
            </p>
          </div>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground">8. Nexus Letter and Medical Document Templates</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            <a href="mailto:blakedrain@gmail.com" className="text-[#D6B25E] hover:underline">
