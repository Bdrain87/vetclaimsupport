  ...
  return (
    <PageContainer className="space-y-6 animate-fade-in py-8">
      ...
      <div className="rounded-lg bg-gold/5 border border-gold/20 px-4 py-2 text-xs text-muted-foreground">
        <span className="font-semibold text-foreground">Effective:</span> {formatLegalDate(LEGAL_VERSIONS.privacy.effectiveDate)} &middot; Version {LEGAL_VERSIONS.privacy.version}
      </div>
