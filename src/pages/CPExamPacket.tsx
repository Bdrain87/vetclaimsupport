...
function PacketSection({
  ...
  return (
    <div className="border border-border rounded-xl overflow-hidden bg-card">
      ...
      >
        <span className="flex items-center justify-center w-7 h-7 rounded-full bg-[#C5A442]/10 text-[#C5A442] text-sm font-bold shrink-0">
          {sectionNumber}
        </span>
        <Icon className="h-5 w-5 text-[#C5A442] shrink-0" />
    ...
    <PageContainer className="py-6 space-y-4 animate-fade-in">
      ...
      <div className="flex items-start gap-4">
        <div className="p-3 rounded-xl bg-[#C5A442]/10 shrink-0">
          <FileCheck className="h-6 w-6 text-[#C5A442]" />
        </div>
                      ...
                      <Badge
                        className={cn(
                          ...
                          condition.claimType === 'secondary'
                            ...
                            ? 'bg-[rgba(197,164,66,0.2)] text-gold border-[rgba(197,164,66,0.3)]'
                            : 'bg-[#C5A442]/20 text-[#F5D680] border-[#C5A442]/30'
                        )}
                      >
                        {condition.claimType}
                      </Badge>
                ...
                return (
                  <div key={condition.id} className="space-y-2">
                    ...
                    {evidence.gaps.length > 0 && (
                      <div className="flex items-start gap-2 p-2 rounded-lg bg-[rgba(197,164,66,0.1)] border border-[rgba(197,164,66,0.2)]">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-foreground">
                    <span className="text-[#C5A442] font-bold mt-0.5 shrink-0">&#x2022;</span>
                    {point}
                  </li>
                ))}
              </ul>
          ...
          <div className="bg-[#7A672A]/30 border border-[#7A672A]/50 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <a href="https://www.va.gov/vbs/bva/" target="_blank" rel="noopener noreferrer"
                 className="flex items-center gap-2 text-[#F5D680] hover:text-[#F5D680] text-sm">
